...
func main() {
	var (
		...
		searchAddr  = flag.String("searchaddr", "search.service.consul:8081", "Search service addr")
		profileAddr = flag.String("profileaddr", "profile.service.consul:8082", "Profile service addr")
	)
	flag.Parse()
